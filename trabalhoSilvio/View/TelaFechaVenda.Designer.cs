namespace trabalhoSilvio.View
{
    partial class TelaFechaVenda
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(TelaFechaVenda));
            label1 = new Label();
            label2 = new Label();
            label3 = new Label();
            label4 = new Label();
            ...
            label3.Location = new Point(327, 91);
            label3.Name = "label3";
            label3.Size = new Size(245, 32);
            label3.TabIndex = 2;
            label3.Text = "85.404.145/0001-00";
            // 
            // label4
            // 
            label4.AutoSize = true;
            label4.Font = new Font("Segoe UI", 18F, FontStyle.Bold, GraphicsUnit.Point);
            label4.Location = new Point(243, 137);
            label4.Name = "label4";
            label4.Size = new Size(338, 32);
            label4.TabIndex = 3;
            label4.Text = "Rua dos Matos. 690 -SBC-SP";
            // 
            // label5
            // 
            label5.AutoSize = true;
            label5.Font = new Font("Segoe UI", 15.75F, FontStyle.Bold, GraphicsUnit.Point);
            label5.Location = new Point(292, 50);
            label5.Name = "label5";
            ...
            label6.Location = new Point(148, 183);
            label6.Name = "label6";
            ...
            label7.Location = new Point(327, 183);
            label7.Name = "label7";
            ...
            label8.Location = new Point(400, 183);
            label8.Name = "label8";
            ...
            label9.Location = new Point(556, 183);
            label9.Name = "label9";
            ...
            label10.Location = new Point(625, 183);
            ...
            label11.Location = new Point(269, 530);
            ...
            label12.Location = new Point(458, 530);
            ...
            label16.Location = new Point(-2, 213);
            label16.Name = "label16";
            label16.Size = new Size(803, 317);
            label16.TabIndex = 16;
